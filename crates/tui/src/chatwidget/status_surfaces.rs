...
impl ChatWidget {
    ...
    /// Clears the terminal title Devo most recently wrote, if any.
    ///
    ...
    pub(super) fn status_line_value_for_item(&mut self, item: &StatusLineItem) -> Option<String> {
        match item {
            ...
            StatusLineItem::DevoVersion => Some(crate::version::CLI_VERSION.to_string()),
    ...
    fn terminal_title_value_for_item(
        ...
        match item {
            TerminalTitleItem::AppName => Some("devo".to_string()),
