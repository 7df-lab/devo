...
const SESSION_NAME: &str = "Devo Windows Sandbox WFP";
const PROVIDER_NAME: &str = "Devo Windows Sandbox WFP";
const PROVIDER_DESCRIPTION: &str = "Persistent WFP provider for Devo Windows sandbox filters";
const SUBLAYER_NAME: &str = "Devo Windows Sandbox WFP";
const SUBLAYER_DESCRIPTION: &str = "Persistent WFP sublayer for Devo Windows sandbox filters";

// WFP identifies persistent providers, sublayers, and filters by stable GUIDs.
// These values are Devo-owned stable GUIDs; do not regenerate them unless we
...
/// Installs the persistent Devo WFP filters for `account`.
///
...
/// Ensures the persistent Devo WFP provider exists.
...
/// Ensures the persistent Devo sublayer exists under the Devo provider.
