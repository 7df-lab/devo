...
fn retry_uses_original_unified_exec_request_and_stops_after_second_failure() {
    ...
    let request = RunnerTransportRequest {
        ...
        devo_home: PathBuf::from(r"C:\Users\devo"),
        cwd: PathBuf::from(r"C:\workspace"),
        env_map: env_map.clone(),
        logs_base_dir: Some(PathBuf::from(r"C:\Users\devo\.sandbox")),
        spawn_request: SpawnRequest {
            ...
            devo_home: PathBuf::from(r"C:\Users\devo\.sandbox"),
            real_devo_home: PathBuf::from(r"C:\Users\devo"),
    ...
    let expected_refresh = RefreshObservation {
        ...
        env_map,
        devo_home: request.devo_home.clone(),
    ...
    let result = spawn_runner_transport_with_retry(
        ...
        &request,
        |devo_home, cwd, sandbox_creds, logs_base_dir, spawn_request| {
