...
use crate::protocol::permissions::FileSystemSandboxKind;
            ...
            .retain(|FileSystemSandboxEntry { path, .. }| {
                !matches!(
                    ...
                    FileSystemPath::Special {
                        value: crate::protocol::permissions::FileSystemSpecialPath::Tmpdir
                            | crate::protocol::permissions::FileSystemSpecialPath::SlashTmp,
                    }
                )
            });
...
mod tests {
    use super::*;
    use crate::protocol::models::ManagedFileSystemPermissions;
    use crate::protocol::permissions::FileSystemAccessMode;
    use crate::protocol::permissions::FileSystemSandboxEntry;
    use crate::protocol::permissions::FileSystemSpecialPath;
    use crate::protocol::permissions::project_roots_glob_pattern;
